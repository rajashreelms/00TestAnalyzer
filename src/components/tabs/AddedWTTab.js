        ...
        <Table stickyHeader size="small">
          ...
          <TableBody>
            {paginatedData.map((r, i) => (
              <TableRow key={`${r.id}-${r.wt}-${i}`} sx={{ bgcolor: ROW_COLORS.added.bg, '&:hover': { bgcolor: ROW_COLORS.added.hover }, transition: 'background 0.15s ease' }}>
